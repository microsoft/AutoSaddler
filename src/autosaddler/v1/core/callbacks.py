...
"""Callback protocol for AutoSaddler optimization instrumentation.

This module provides a callback system for observing AutoSaddler optimization runs.
...
if TYPE_CHECKING:
    from autosaddler.v1.core.data_loader import DataLoader
    from autosaddler.v1.core.state import GEPAState, ProgramIdx
...
class GEPACallback(Protocol):
    """Protocol for AutoSaddler optimization callbacks.
