...
from autosaddler.v1.core.state import ProgramIdx
...
class GEPAResult(Generic[RolloutOutput, DataId]):
    """Immutable snapshot returned by :func:`~autosaddler.v1.api.optimize`.
    ...
    def best_idx(self) -> int:
        ...
        # Tie-break: prefer the latest iteration (highest index)
